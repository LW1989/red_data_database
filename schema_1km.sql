-- Auto-generated fact table definitions for 1km grid
-- Generated by scripts/generate_schema.py
-- Data types determined by inspecting actual data values (decimal comma detection)


-- Alter_INFR fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_alter_infr (
...
-- Anteil_Auslaender fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_anteil_auslaender (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
...
-- Anteil_ueber_65 fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_anteil_ueber_65 (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
...
-- Anteil_unter_18 fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_anteil_unter_18 (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
...
-- Auslaenderanteil_ab18 fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_auslaenderanteil_ab18 (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
...
-- Baujahr_JZ fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_baujahr_jz (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
...
-- Bevoelkerungszahl fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_bevoelkerungszahl (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
    einwohner INTEGER,
    x_mp_1km NUMERIC,
...
-- Deutsche_Staatsangehoerige_ab18 fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_deutsche_staatsangehoerige_ab18 (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
...
-- Durchschn_Flaeche_je_Bewohner fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_durchschn_flaeche_je_bewohner (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
...
-- Durchschn_Flaeche_je_Wohnung fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_durchschn_flaeche_je_wohnung (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
...
-- Durchschn_Haushaltsgroesse fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_durchschn_haushaltsgroesse (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
...
-- Durchschn_Nettokaltmiete fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_durchschn_nettokaltmiete (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
...
-- Durchschnittliche_Nettokaltmiete_und_Anzahl_der_Wohnungen fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_durchschnittliche_nettokaltmiete_und_anzahl_der_wohnungen (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
    durchschnmieteqm NUMERIC,
...
-- Durchschnittsalter fact table for 1km grid
...
-- Eigentuemerquote fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_eigentuemerquote (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
...
-- Energietraeger fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_energietraeger (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
...
-- Familienstand fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_familienstand (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
    insgesamt_bevoelkerung NUMERIC,
    ledig NUMERIC,
...
-- Geb_Gebaeudetyp_Groesse fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_geb_gebaeudetyp_groesse (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
    insgesamt_gebaeude NUMERIC,
    freiefh NUMERIC,
...
-- Gebaeude_mit_Wohnraum_nach_ueberwiegender_Heizungsart fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_gebaeude_mit_wohnraum_nach_ueberwiegender_heizungsart (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
...
-- Geburtsland_Gruppen fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_geburtsland_gruppen (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
    insgesamt_bevoelkerung NUMERIC,
    deutschland NUMERIC,
...
-- Groesse_des_privaten_Haushalts fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_groesse_des_privaten_haushalts (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
    insgesamt_bevoelkerung NUMERIC,
...
-- Grosse_Kernfamilie_bis6undmehrPers fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_grosse_kernfamilie_bis6undmehrpers (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
...
-- Heizungsart fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_heizungsart (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
    insgesamt_heizungsart NUMERIC,
    fernheizung NUMERIC,
...
-- Leerstandsquote fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_leerstandsquote (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
...
-- Marktaktive_Leerstandsquote fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_marktaktive_leerstandsquote (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
...
-- Staatsangehoerigkeit fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_staatsangehoerigkeit (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
    insgesamt_bevoelkerung NUMERIC,
    deutschland NUMERIC,
...
-- Staatsangehoerigkeit_Gruppen fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_staatsangehoerigkeit_gruppen (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
    insgesamt_bevoelkerung NUMERIC,
    deutschland NUMERIC,
...
-- Typ_priv_HH_Familie fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_typ_priv_hh_familie (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
    insgesamt_haushalte NUMERIC,
...
-- Typ_priv_HH_Lebensform fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_typ_priv_hh_lebensform (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
    insgesamt_haushalte NUMERIC,
    einpershh_singlehh NUMERIC,
...
-- Wohnung_Gebaeudetyp_Groesse fact table for 1km grid
CREATE TABLE IF NOT EXISTS zensus.fact_zensus_1km_wohnung_gebaeudetyp_groesse (
    grid_id TEXT PRIMARY KEY,
    year INTEGER NOT NULL DEFAULT 2022,
    insgesamt_wohnungen NUMERIC,
    freiefh NUMERIC,
